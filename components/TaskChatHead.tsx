...
import { X, CheckSquare, Calendar, Filter } from "lucide-react";
import {
  addTask,
              ...
              <CardContent>
                  ...
                  <div className="flex space-x-2">
                    ...
                    <Popover>
                      <PopoverTrigger asChild>
                        <Button
                          variant="outline"
                          className="w-[160px] pl-3 text-left font-normal"
                        >
                          {newTaskDueDate ? (
                ...
                <div className="flex justify-between items-center mb-4">
                  ...
                  <Popover>
                    ...
                    <PopoverContent className="w-auto p-0 z-[200]" align="end" sideOffset={5}>
                      <CalendarComponent
                        mode="single"
                        selected={filterDate}
                ...
                <ScrollArea className="h-[300px] pr-4">
                  {sortedTasks.map((task, index) => (
                    ...
                    >
                      <div
                        key={task.id}
                        className="flex items-center space-x-2 mb-4 bg-gray-50 p-3 rounded-lg"
                      >
                        <Checkbox
                        ...
                        <Select
                          value={task.priority}
                          onValueChange={(value) =>
                            handleUpdatePriority(task.id, value)
                          }
                        >
